...
table.insert(SFQuest_Database.DialoguePool, {dialoguecode = "SFQuest_Questyno_JuanBaker_Complete", context = "ContextMenu_WorldEvent_TalkTo",command = "unlockquest;Questyno_JuanBaker", optional = true, text = "IGUI_SFQuest_Questyno_JuanBaker_Begin", textaccepted = "IGUI_SFQuest_Questyno_JuanBaker_Accepted",textdeclined = "IGUI_SFQuest_Questyno_JuanBaker_Declined"})
