...
table.insert(SFQuest_Database.DialoguePool, {dialoguecode = "SFQuest_Questyno_EzekielFlynn5_Begin", context = "ContextMenu_WorldEvent_TalkTo", command = "unlockquest;Questyno_EzekielFlynn5", optional = true, text = "IGUI_SFQuest_Questyno_EzekielFlynn5_Begin_Text", textaccepted = "IGUI_SFQuest_Questyno_EzekielFlynn5_Begin_Text_Accepted",textdeclined = "IGUI_SFQuest_Questyno_EzekielFlynn5_Begin_Text_Declined", sound = {begin = "dialogues/Questyno_Ezekiel_5"}})
