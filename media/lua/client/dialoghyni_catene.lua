...
table.insert(SFQuest_Database.DialoguePool, { dialoguecode = "SFQuest_Questyno_EzekielFlynn1_Complete", context = "ContextMenu_WorldEvent_TalkTo", command = "completequest;Questyno_EzekielFlynn1", text = "IGUI_SFQuest_Questyno_EzekielFlynn1_Complete", sound = {begin = "dialogues/Questyno_Ezekiel_Complete"}})
...
table.insert(SFQuest_Database.DialoguePool, { dialoguecode = "SFQuest_Questyno_ElowenBeckett2_Complete", context = "ContextMenu_WorldEvent_TalkTo", command = "completequest;Questyno_ElowenBeckett2_A", text = "IGUI_SFQuest_Questyno_ElowenBeckett2_Complete"})
